...
> [![The title card for Gnocchi.club, my groceries app. It shows a pan with various ingredients in it, and a screenshot of the grocery list page in the app.](https://gnocchi.club/og-image.png)](https://gnocchi.club)
> Almost every technique I cover here, I've put into practice in my latest app, [Gnocchi](https://gnocchi.club), which I've been building over the past year both as a useful grocery list and recipe manager, but also an experiment to see how far I could push web app UX. And I'm pretty happy with the results! See for yourself.
