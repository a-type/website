...
> [![The title card for Gnocchi, my groceries app. It shows a pan with various ingredients in it, and a screenshot of the grocery list page in the app.](https://gnocchi.biscuits.club/og-image.png)](https://biscuits.club/gnocchi)
> Almost every technique I cover here, I've put into practice in my latest app, [Gnocchi](https://biscuits.club/gnocchi), which I've been building over the past year both as a useful grocery list and recipe manager, but also an experiment to see how far I could push web app UX. And I'm pretty happy with the results! See for yourself.
...
<Caption>
  ...
  <a target="_blank" href="https://biscuits.club/gnocchi">
    Gnocchi.
  </a>
</Caption>
...
When was the last time you accidentally highlighted an image in a native app? Never? That’s because native UIs don’t even allow that (at least, by default). In fact, more often than not, you can’t select most text in native apps… even stuff you really _should_ be able to.
...
> **Note:** Recent experimentation has indicated this may no longer be necessary on Android. Try going without and seeing how it works for you. I'm currently testing out just using `position: fixed` and `bottom: 0` alone.
...
Update: I don't use this anymore for top-level navigation, as it feels distracting in practice. But it still makes tab navigation (where tabs are at the top) more native-feeling and easier to access on a phone.

<Video src="/images/blog/pwa-native/gnocchi-nav-gestures.mp4" />
<Caption>
  My app,{' '}
  <a href="https://biscuits.club/gnocchi" target="_blank">
    Gnocchi
  </a>
